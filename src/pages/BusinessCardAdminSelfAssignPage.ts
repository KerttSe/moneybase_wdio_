...
const ADMIN_SELF_ASSIGN_ALERT_TITLE = process.env.ADMIN_SELF_ASSIGN_ALERT_TITLE!
const ADMIN_SELF_ASSIGN_ALERT_MESSAGE = process.env.ADMIN_SELF_ASSIGN_ALERT_MESSAGE!
